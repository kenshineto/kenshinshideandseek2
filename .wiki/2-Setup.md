...
The Packet Events plugin is required for the plugin to work. You can download it at their [spigotmc](https://www.spigotmc.org/resources/packetevents-api.80279/) page or teir [modrinth](https://modrinth.com/plugin/packetevents) page.
